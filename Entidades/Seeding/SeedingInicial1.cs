...
{
    public class SeedingInicial1
    {
        public static void Seed(ModelBuilder modeloBuilder)
        {
            var rachelMcAdams = new Actor() 
            { 
                Id = 3, 
                Name = "Rachel Anne McAdams", 
                FechaNacimiento = new DateTime(1978, 11, 17), 
                Fortuna = 15000 
            };
            ...
            modeloBuilder.Entity<PeliculaActor>().HasData( mcAdams, mcAdams2, robert);
